...
output onedriveConnectionName string = resources.outputs.onedriveConnectionName
output onedriveConnectionRuntimeUrl string = resources.outputs.onedriveConnectionRuntimeUrl
