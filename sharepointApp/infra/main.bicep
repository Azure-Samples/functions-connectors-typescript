...
output sharepointConnectionName string = resources.outputs.sharepointConnectionName
output sharepointConnectionRuntimeUrl string = resources.outputs.sharepointConnectionRuntimeUrl
